...
public void Recorridoinorden(DefaultMutableTreeNode nodoRaiz)
    {
        if(!nodoRaiz.getUserObject().toString().equals("I - NULL") && !nodoRaiz.getUserObject().toString().equals("D - NULL"))
        {
            Recorridoinorden((DefaultMutableTreeNode) nodoRaiz.getFirstChild()); // Nodo de lado izquierdo
            strRecorrido += nodoRaiz.getUserObject().toString().split("-")[1].trim() + " - "; // Nodo principal 
            Recorridoinorden((DefaultMutableTreeNode) nodoRaiz.getLastChild());  // Nodo de lado derecho 
        }
    }
...
public void Recorridopostorden(DefaultMutableTreeNode nodoRaiz)
    {
        if(!nodoRaiz.getUserObject().toString().equals("I - NULL") && !nodoRaiz.getUserObject().toString().equals("D - NULL"))
        {
            Recorridopostorden((DefaultMutableTreeNode) nodoRaiz.getFirstChild()); // Nodo de lado izquierdo
            Recorridopostorden((DefaultMutableTreeNode) nodoRaiz.getLastChild());  // Nodo de lado derecho
            strRecorrido += nodoRaiz.getUserObject().toString().split("-")[1].trim() + " - "; // Nodo principal 
